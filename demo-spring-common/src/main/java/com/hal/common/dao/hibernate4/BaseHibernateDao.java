package com.hal.common.dao.hibernate4;
...
import com.hal.common.dao.util.ConditionQuery;
import com.hal.common.dao.util.OrderBy;
import com.hal.common.pagination.PageUtil;
import com.hal.common.util.Assert;
...
public abstract class BaseHibernateDao<M extends java.io.Serializable, PK extends java.io.Serializable> implements IBaseDao<M, PK> {
    ...
    public List<M> pre(PK pk, int pn, int pageSize) {
        ...
        //倒序，重排
        Object[] objs={pk};
        List<M> result = list(HQL_OPTIMIZE_PRE_LIST_ALL, 1, pageSize, objs);
    ...
    public List<M> next(PK pk, int pn, int pageSize) {
        ...
        Object[] objs={pk};
        return list(HQL_OPTIMIZE_NEXT_LIST_ALL, 1, pageSize, objs);
    }
    ...
    @SuppressWarnings("unchecked")
    protected <T> List<T> list(final String hql, final int pn, final int pageSize) {
       return list(hql,pn,pageSize,null);
    }
